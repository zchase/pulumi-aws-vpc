...
namespace Pulumi.AwsVpc
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.AwsVpc.version.txt");
    ...
    internal sealed class AwsVpcResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public AwsVpcResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
