...
{
    [AwsVpcResourceType("aws-vpc:index:Vpc")]
    public partial class Vpc : Pulumi.ComponentResource
    {
        ...
        public Vpc(string name, VpcArgs? args = null, ComponentResourceOptions? options = null)
            : base("aws-vpc:index:Vpc", name, args ?? new VpcArgs(), MakeResourceOptions(options, ""), remote: true)
        {
        }
    ...
    public sealed class VpcArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("natGateways")]
        public Pulumi.AwsVpc.NatGatewayStrategy? NatGateways { get; set; }
